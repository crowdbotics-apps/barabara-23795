"""barabara_23795 URL Configuration
...
admin.site.site_header = "BARABARA"
admin.site.site_title = "BARABARA Admin Portal"
admin.site.index_title = "BARABARA Admin"

# swagger
api_info = openapi.Info(
    title="BARABARA API",
    default_version="v1",
    description="API documentation for BARABARA App",
)
